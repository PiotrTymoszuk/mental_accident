...
Permutation importance for explanatory variables expressed as accuracy loss [@Strobl2008] was obtained for the conditional random forest algorithm with the function 'varimp()` from the _party_ package.
